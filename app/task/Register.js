...
export default class Login extends Component {
	render() {
		return (
			<Container>
				<Header transparent>
					<Left><Text>Daftar</Text></Left>
					<Right>
						<Button transparent onPress={()=> this.props.navigation.navigate('Login')}>
							<Text style={{color: 'green'}}>Masuk</Text>
						</Button>
					</Right>
				</Header>
				<Content padder style={{backgroundColor: '#f0f0f0'}}>
							...
							<Button full style={{backgroundColor: 'green', borderRadius: 5}}>
								<Text style={{color: '#fff'}}>Daftar</Text>
							</Button>
							
							<Text style={{marginBottom: 10, marginTop: 50}}>Daftar dengan:</Text>
